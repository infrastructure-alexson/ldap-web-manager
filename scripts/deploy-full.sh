...
echo "  - Web Interface: https://ldap-manager.eh168.alexson.org"
echo "  - API Documentation: https://ldap-manager.eh168.alexson.org/docs"
echo "  - API Alternative Docs: https://ldap-manager.eh168.alexson.org/redoc"
echo ""
print_warning "Next Steps:"
echo "  1. Ensure DNS is configured for ldap-manager.eh168.alexson.org"
